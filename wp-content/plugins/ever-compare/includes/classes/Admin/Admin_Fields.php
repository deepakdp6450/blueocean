...
class Admin_Fields {
    ...
    public function get_settings_sections() {
        $sections = array(
            ...
            array(
                'id'    => 'ever_compare_settings_general',
                'title' => esc_html__( 'General Settings', 'ever-compare' ),
            ),
    ...
    protected function fields_settings() {
        ...
        $settings_fields = array(
            ...
            'ever_compare_settings_general' => array(

                array(
                    'name'      => 'enable_success_notification',
                    'label'     => __( 'Show successful notification', 'ever-compare' ),
                    'type'      => 'checkbox',
                    'default'   => 'off',
                    'desc'      => esc_html__( 'Enable this option to display a notification when a client adds or removes a product from the compare.', 'ever-compare' ),
                ),

                array(
                    'name'      => 'success_added_notification_text',
                    'label'     => __( '"Product added to compare" Text', 'ever-compare' ),
                    'type'      => 'text',
                    'default'   => __( '{product_name} added to compare.', 'ever-compare'),
                    'desc'      => esc_html__( 'You can use the placeholder {product_name} to get the current product name.', 'ever-compare' ),
                    'class'       => 'depend_enable_success_notification'
                ),
                array(
                    'name'      => 'success_removed_notification_text',
                    'label'     => __( '"Product removed from compare" Text', 'ever-compare' ),
                    'type'      => 'text',
                    'default'   => __( '{product_name} removed from compare.', 'ever-compare'),
                    'desc'      => esc_html__( 'You can use the placeholder {product_name} to get the current product name.', 'ever-compare' ),
                    'class'       => 'depend_enable_success_notification'
                ),
                array(
                    'name'      => 'removed_notification_after',
                    'label'     => __( 'Remove Notification automatically after (seconds)', 'ever-compare' ),
                    'type'      => 'number',
                    'default'   => 4,
                    'min'       => -1,
                    'desc'      => esc_html__( 'If you wish to always display the notification, please input the value "-1".', 'ever-compare' ),
                    'class'       => 'depend_enable_success_notification'
                ),
            ),
            ...
            'ever_compare_settings_tabs' => array(
                ...
                array(
                    ...
                    'label'  => __( 'Remove product from compare on second click', 'ever-compare' ),
                    'type'  => 'checkbox',
                    'default' => 'off',
                    'desc'    => __( 'Remove the product from the compare if it has already been added.', 'ever-compare' ),
                ),
                ...
                array(
                    ...
                    'label'       => __( 'Remove button text', 'ever-compare' ),
                    'desc'        => __( 'Enter the compare remove button text.', 'ever-compare' ),
                    'type'        => 'text',
                    'default'     => __( 'Remove', 'ever-compare' ),
                    'placeholder' => __( 'Remove', 'ever-compare' ),
                    'class'       => 'depend_remove_on_click',
                ),
            ...
            'ever_compare_table_settings_tabs' => array(
                ...
                array(
                    'name'    => 'limit',
                    'label'   => esc_html__( 'Limit', 'ever-compare' ),
                    'desc'    => esc_html__( 'You can manage your maximum compare quantity from here.', 'ever-compare' ),
                    'type'    => 'number',
                    'min'              => 1,
                    'max'              => 1500,
                    'step'             => 1,
            ...
            'ever_compare_style_tabs' => array(
                ...
                array(
                    ...
                    'label'   => __( 'Notification style', 'ever-compare' ),
                    'desc'    => __( 'Choose a style for the compare notification here.', 'ever-compare' ),
                    'type'    => 'select',
                    'default' => 'default',
                    'options' => [
                        'default' => esc_html__( 'Default', 'ever-compare' ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the color of the button.', 'ever-compare' ) ),
                    'type'  => 'color',
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the hover color of the button.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_button_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the background color of the button.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_button_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the hover background color of the button.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_button_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the border color of the button.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_button_custom_style',
                ),
                ...
                array(
                    ...
                    'label' => esc_html__( 'Border color', 'ever-compare' ),
                    'desc'  => wp_kses_post( __( 'Set the border color of the table.', 'ever-compare' ) ),
                    'type'  => 'color',
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the background color of the table event column.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_table_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the background color of the table odd column.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_table_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the heading color of the table event column.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_table_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the heading color of the table odd column.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_table_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the content color of the table event column.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_table_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the content color of the table odd column.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_table_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the content link color of the table.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_table_custom_style',
                ),
                ...
                array(
                    ...
                    'desc'  => wp_kses_post( __( 'Set the content link hover color of the table.', 'ever-compare' ) ),
                    'type'  => 'color',
                    'class' => 'depend_table_custom_style',
                ),
                ...
                array(
                    ...
                    'headding'=> __( 'Notification custom style', 'ever-compare' ),
                    'type'    => 'title',
                    'size'    => 'margin_0 regular',
                    'class' => 'depend_notification_custom_style element_section_title_area',
                ),

                array(
                    'name'  => 'notification_bg_color',
                    'label' => esc_html__( 'Background Color', 'ever-compare' ),
                    'desc'  => __( 'Set the background color of the notification.', 'ever-compare' ),
                    'type'  => 'color',
                    'class' => 'depend_notification_custom_style',
                ),
                array(
                    'name'  => 'notification_border_color',
                    'label' => esc_html__( 'Border Color', 'ever-compare' ),
                    'desc'  => __( 'Set the border color of the notification.', 'ever-compare' ),
                    'type'  => 'color',
                    'class' => 'depend_notification_custom_style',
                ),
                array(
                    'name'  => 'notification_text_color',
                    'label' => esc_html__( 'Content Color', 'ever-compare' ),
                    'desc'  => __( 'Set the content color of the notification.', 'ever-compare' ),
                    'type'  => 'color',
                    'class' => 'depend_notification_custom_style',
                ),
                array(
                    'name'  => 'notification_btn_color',
                    'label' => esc_html__( 'Close Button Color', 'ever-compare' ),
                    'desc'  => __( 'Set the close button color of the notification.', 'ever-compare' ),
                    'type'  => 'color',
                    'class' => 'depend_notification_custom_style',
                ),
                array(
                    'name'  => 'notification_btn_color_hover',
                    'label' => esc_html__( 'Close Button Hover Color', 'ever-compare' ),
                    'desc'  => __( 'Set the close button hover color of the notification.', 'ever-compare' ),
                    'type'  => 'color',
                    'class' => 'depend_notification_custom_style',
                ),
