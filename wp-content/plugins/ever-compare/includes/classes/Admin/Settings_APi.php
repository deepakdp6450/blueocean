...
class Settings_APi {
    ...
    function admin_enqueue_scripts( $hook ) {
        if ( false === strpos( $hook, 'evercompare' ) ) {
            return;
        }
    ...
    function callback_multicheckshort( $args ) {
        ...
        $html  = '<fieldset><input type="checkbox" class="htoption-shortable-checkall">'.esc_html__( 'Check All', 'ever-compare' ).'<ul class="htoption_shortable">';
        $html .= sprintf( '<input type="hidden" name="%1$s[%2$s]" value="" />', $args['section'], $args['id'] );
    ...
    function callback_file( $args ) {
        ...
        $label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'ever-compare' );
    ...
    function callback_image_upload( $args ) {
        ...
        $id    = $args['section']  . '[' . $args['id'] . ']';
        $label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'ever-compare' );
        $remove_label = isset( $args['options']['button_remove_label'] ) ? $args['options']['button_remove_label'] : __( 'Remove', 'ever-compare' );
