                                                ...
                                                <span class="downloaded-count">
                                                    <?php
                                                        if( $plugins_type == 'free' ){
                                                            ...
                                                            printf( esc_html__( '%s Active Installations', 'ever-compare' ), esc_html($this->active_install_count( $prepare_plugin[$data['slug']]['active_installs'] )) );
                                                        }
                                                    ?>
                                                </span>
                                            </div>
    ...
    public function active_install_count( $active_installs ){
        ...
        if ( $active_installs >= 1000000 ) {
            ...
            $active_installs_text     = sprintf(
                ...
                _nx( '%s+ Million', '%s+ Million', $active_installs_millions, 'Active plugin installations', 'ever-compare' ),
                number_format_i18n( $active_installs_millions )
            );
        } elseif ( 0 === $active_installs ) {
            $active_installs_text = _x( 'Less Than 10', 'Active plugin installations', 'ever-compare' );
        } else {
