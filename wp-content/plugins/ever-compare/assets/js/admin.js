...
"use strict";
	...
	var EverCompareAdmin = {
		...
		init: function(){
            ...
            this.HideShowField( '.depend_remove_on_click', evercompare.option_data['remove_on_click'], 'on' );
            this.HideShowField( '.depend_enable_success_notification', evercompare.option_data['enable_success_notification'], 'on' );
            this.HideShowField( '.depend_notification_custom_style', evercompare.option_data['notification_style'], 'custom' );
            ...
            this.ConditionField( '.remove_on_click .checkbox', '.depend_remove_on_click', 'on', 'radio' );
            this.ConditionField( '.enable_success_notification .checkbox', '.depend_enable_success_notification', 'on', 'radio' );
            this.ConditionField( '.notification_style select', '.depend_notification_custom_style', 'custom' );
