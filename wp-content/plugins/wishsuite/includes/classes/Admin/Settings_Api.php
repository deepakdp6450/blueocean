...
class Settings_Api {
     ...
     */
    public function callback_table( $args ) {
        ...
        <div class="wrap">
            <?php
                ...
                if($user_id) {
                    ...
                    if($user) {
                        $title .= " of - " . ucfirst($user->display_name); 
                    } else {
                        $title .= " of - Guest" . $user_id;
                    }
                }
            ?>
            ...
            <?php foreach ( $this->settings_sections as $form ) { ?>
                <div id="<?php echo $form['id']; ?>" class="group" style="display: none;">
                    <form method="post" action="options.php">
                        ...
                        if ( isset( $this->settings_fields[ $form['id'] ] ) && $form['id'] !== 'wishsuite_wishlist_tabs' ):
                        ?>
